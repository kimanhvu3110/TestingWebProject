<%-- 
    Document   : homeBarTwo
    Created on : Mar 14, 2022, 11:00:14 PM
    Author     : black
--%>
        ...
        *{
        ...
        .dropdown:hover .dropbtn {
            ...
            <div class="header">
                ...
                <a id="s5" href="myWall">Tài khoản</a>
                <a id="s6" href="logOut">Đăng Xuất</a>
                <a id="Loicon" style=" position:relative; margin-left: 150px; " ><span class="fa fa-user-circle-o" aria-hidden="true" style="color: green;"></span></a>
            </div>              
    </div>
